...
import 'package:fast_pass/app/utils/alert/type/cancel.dart';
import 'package:fast_pass/app/utils/alert/type/confirm.dart';
import 'package:fast_pass/app/utils/alert/type/success.dart';
...
abstract class SweetAlert {
    static Color success = Color.fromRGBO(71, 124, 247, 1);
    static Color danger = new Color(0xffDD6B55);
    static Color cancel = new Color(0xffD0D0D0);

    static String successText = "确定";
    static String confirmText = "确定";
    static String cancelText = "取消";
