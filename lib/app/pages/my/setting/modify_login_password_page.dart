...
class ModifyLoginPasswordPage extends StatelessWidget {
@override
...
class ModifyPasswordFromDemo extends StatefulWidget {
    @override
    _ModifyPasswordFromDemoState createState() => _ModifyPasswordFromDemoState();
}

class _ModifyPasswordFromDemoState extends State<ModifyPasswordFromDemo> {
            ...
            HttpUtil().post(
                ...
                data: {
                    ...
                    if(response['error'] == 0){
                        ...
                        UserInfoCache().saveInfo(key: UserInfoCache.loginPassword,value: '');
                        //简单计时器
