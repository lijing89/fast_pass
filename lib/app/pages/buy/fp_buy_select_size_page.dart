...
class FPBuySelectSizePage extends StatefulWidget {
  final String id;
  FPBuySelectSizePage({this.id});
  @override
  _FPBuySelectSizePageState createState() => _FPBuySelectSizePageState();
}

class _FPBuySelectSizePageState extends State<FPBuySelectSizePage> {
  ///商品信息
  String _selectSize = '--';
  String _sizeId = '0';
  String _goodName = '';
