...
class FPBuyTipsPage extends StatefulWidget {
  final String id;
  final String type;
  FPBuyTipsPage({this.id, this.type});
  @override
  _FPBuyTipsPageState createState() => _FPBuyTipsPageState();
}

class _FPBuyTipsPageState extends State<FPBuyTipsPage> {
              ...
              child: Column(
                children: <Widget>[
                  ...
                  Expanded(
                    child: Container(
                      child: WebView(
                        initialUrl: 'https://kuaichuan.net:8443/fp-ops/tip/buytip.html',
...
//                    bottom:ScreenUtil.getInstance().setHeight(110.0),
//                  ),
                    child: Column(
                      children: <Widget>[
                              ...
                              GestureDetector(
                                onTap: (){
                                  ...
                                  if(widget.type == '1'){
                                    ...
                                    Application.router.navigateTo(context, '${Routes.buySelectSize}?id=${widget.id}',transition: TransitionType.native);
                                  }else{
                                    Navigator.pop(context);
                                    Application.router.navigateTo(context, '${Routes.buyAddress}?id=${widget.id}',transition: TransitionType.native);
                                  }
